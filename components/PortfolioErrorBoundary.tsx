...
export class PortfolioErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error("[PortfolioErrorBoundary] Portfolio section crashed:", error, errorInfo.componentStack);
  }
    ...
    if (this.state.hasError) {
      return (
        ...
        >
          ...
          <div>
            <p className="font-semibold text-destructive">Portfolio unavailable</p>
            <p className="mt-2 text-sm text-foreground-muted">
              Something went wrong loading your portfolio. Other sections are unaffected.
            </p>
          </div>
